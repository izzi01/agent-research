"""
TextCheapCreator Agent - Cost-optimized Vietnamese social media copy generation using GLM-4.6

This agent:
1. Takes content briefs from ContentStrategist
2. Generates platform-specific Vietnamese copy (Facebook, TikTok, Shopee) using GLM-4.6
...
6. Uses cost-optimized GLM-4.6 for efficient content generation
"""
...
class TextCheapCreator(Agent):
    """
    Cost-optimized Agent that generates final Vietnamese social media copy from content briefs using GLM-4.6
    """
...
if __name__ == "__main__":
    ...
    app = agentOs.get_app()
    agentOs.serve(app="my_os:app", reload=True)
